...
<div class="${"content"}">
    ...
    default: () => {
      return `my blog`;
		...
		<div class="${"mini-section svelte-jnvd3t"}"><div class="${"text-left svelte-jnvd3t"}"><h1>i write...</h1>
				...
				<div class="${"buttons"}">${validate_component(Link, "Link").$$render($$result, { link: "/portfolio?tab=projects" }, {}, {
    default: () => {
	...
	<div class="${"section outro svelte-jnvd3t"}"><h1>i create.</h1>
		...
		<div class="${"media-icon-container svelte-jnvd3t"}"><a sveltekit:prefetch href="${"mailto:vivianwli.design@gmail.com"}" target="${"_blank"}">${validate_component(Icon, "Icon").$$render(
    $$result,
    {
      src: FiMail,
    ...
    {}
			...
			<a sveltekit:prefetch href="${"https://github.com/vivianwli"}" target="${"_blank"}">${validate_component(Icon, "Icon").$$render(
    $$result,
    {
      src: FiGithub,
      className: "custom-icon media-icon"
    ...
    {}
			...
			<a sveltekit:prefetch href="${"https://www.linkedin.com/in/vivianwli/"}" target="${"_blank"}">${validate_component(Icon, "Icon").$$render(
    $$result,
    {
      src: FiLinkedin,
      className: "custom-icon media-icon"
    ...
    {}
			...
			<a sveltekit:prefetch href="${"https://instagram.com/mclovivian"}" target="${"_blank"}">${validate_component(Icon, "Icon").$$render(
    $$result,
    {
      src: FiInstagram,
      className: "custom-icon media-icon"
