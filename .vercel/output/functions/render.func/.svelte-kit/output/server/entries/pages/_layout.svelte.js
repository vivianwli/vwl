...
const Menu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${
		open
			? `<div class="${'svelte-ym2u08'}">${each(['home', 'portfolio', 'blog'], (link, i) => {
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `${
			(($$result.head += `<!-- HEAD_svelte-104j92h_START --><script>savedTheme = localStorage.getItem('theme') ? localStorage.getItem('theme') : null;
...
<div class="${'scroll-bar-wrap'}"><div class="${'scroll-box'}"><div class="${'header svelte-qis14i'}">
			<div class="${'mobile-nav'}"><div style="display: contents; --color:${'var(--secondary-color)'}; --padding:${'2.4rem'}; --layer-width:${'25px'}; --layer-height:${'3px'}; --layer-spacing:${'5px'};">${validate_component(
				Hamburger,
				'Hamburger'
			).$$render(
				$$result,
