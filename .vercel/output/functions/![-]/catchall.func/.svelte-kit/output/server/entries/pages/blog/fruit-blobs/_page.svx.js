...
const blobs1 = "/_app/immutable/assets/blobberries.CoEIvGJF.png";
const blobs2 = "/_app/immutable/assets/blobcitrus.BF-uSuf7.png";
const blobs3 = "/_app/immutable/assets/blobsuggestive.BlpDbv9g.png";
const blobs4 = "/_app/immutable/assets/basicbasket.C9eawEaL.png";
const metadata = {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(PostHeader, "PostHeader").$$render(
    ...
    {},
    {}
  )} <p data-svelte-h="svelte-x0mr7u">I received a Discord Nitro gift for my birthday month (July!), which ultimately catalyzed the creation of these fruit and vegetable blob emojis. The day after I received the gift, I started aggressively joining servers to use their emotes globally. Then, I noticed that Blob Hub Studios was actively accepting pack submissions and that there was a crucial demand in the market for fruit blobs, so I took the plunge.</p> <p data-svelte-h="svelte-1sgw1wq">Join my <a href="https://discord.gg/AA2pvSU" rel="nofollow">Discord server</a> and use these blob emojis for your self (global use only available for Nitro users)! Additionally, my blobs are copyrighted by Blob Hub Studios. Join the <a href="https://discord.gg/yATKMY8" rel="nofollow">larger network</a>, too, which is home to over 12,000 unique blobs. Since submitting this pack, I’ve been named a Blob Designer as part of the Blob Hub Staff. Below are some of my favorite emojis I’ve created!</p> ${validate_component(BlogGallery, "BlogGallery").$$render($$result, { columns: "2" }, {}, {
    default: () => {
