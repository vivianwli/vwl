...
import { P as Fr, B as N } from '../../../../chunks/BlogImage-f532aefd.js';
import { B as ia } from '../../../../chunks/BlogGallery-87cb4976.js';
const qr = '' + new URL('../../../../assets/election-admin-1-27f83f43.png', import.meta.url).href,
	zr = '' + new URL('../../../../assets/election-admin-2-5430b1a7.png', import.meta.url).href,
	Jr = '' + new URL('../../../../assets/election-admin-3-96115cba.png', import.meta.url).href,
	Xr = '' + new URL('../../../../assets/election-admin-4-e39d09a6.png', import.meta.url).href,
	Qr = '' + new URL('../../../../assets/election-admin-5-894d02ea.png', import.meta.url).href,
	Zr = '' + new URL('../../../../assets/election-admin-6-22605ea5.png', import.meta.url).href,
	Kr =
		'' + new URL('../../../../assets/nyt-asset-layout-editor-fd2ec975.gif', import.meta.url).href,
	Vr = '' + new URL('../../../../assets/nhtsa-1-c2a8f811.png', import.meta.url).href,
	el = '' + new URL('../../../../assets/nhtsa-2-e3854018.png', import.meta.url).href,
	tl =
		'' +
		new URL('../../../../assets/nyt-design-systems-library-3de36014.gif', import.meta.url).href,
	al = '' + new URL('../../../../assets/intern-newsletter-1-d533ab12.png', import.meta.url).href,
	ol = '' + new URL('../../../../assets/intern-newsletter-2-b7006c9f.png', import.meta.url).href,
	sl = '' + new URL('../../../../assets/intern-newsletter-3-97ac0fc0.png', import.meta.url).href,
	nl = '' + new URL('../../../../assets/intern-newsletter-4-5a38adf3.png', import.meta.url).href,
	il = '' + new URL('../../../../assets/intern-newsletter-5-72060caa.png', import.meta.url).href,
	rl = '' + new URL('../../../../assets/nyt-maker-banner-60d9336f.png', import.meta.url).href,
	ll = '' + new URL('../../../../assets/nyt-maker-2022-13031170.png', import.meta.url).href,
	ml = '' + new URL('../../../../assets/maker-week-team-4204386c.png', import.meta.url).href,
	fl = '' + new URL('../../../../assets/snacks-channel-19ddca4a.png', import.meta.url).href,
	dl = '' + new URL('../../../../assets/trending-races-716bdee1.gif', import.meta.url).href,
	pl =
		'' + new URL('../../../../assets/trending-race-iterations-a479c16a.png', import.meta.url).href,
	hl = '' + new URL('../../../../assets/trending-races-github-06a2af46.png', import.meta.url).href,
	cl = '' + new URL('../../../../assets/trending-races-praise-35615d67.png', import.meta.url).href;
function ul(U) {
	let h, g, c, T;
	return (
		(h = new N({
		...
		{
			c() {
				(y(h.$$.fragment), (g = d()), y(c.$$.fragment));
			},
			l(f) {
				(v(h.$$.fragment, f), (g = p(f)), v(c.$$.fragment, f));
			},
			m(f, _) {
				(b(h, f, _), i(f, g, _), b(c, f, _), (T = !0));
			},
			p: ra,
			i(f) {
				T || ($(h.$$.fragment, f), $(c.$$.fragment, f), (T = !0));
			},
			o(f) {
				(I(h.$$.fragment, f), I(c.$$.fragment, f), (T = !1));
			},
			d(f) {
				(k(h, f), f && t(g), k(c, f));
			}
...
function yl(U) {
	let h, g, c, T;
	return (
		(h = new N({ props: { src: Vr, className: 'gallery-img' } })),
		(c = new N({ props: { src: el, className: 'gallery-img' } })),
		{
			c() {
				(y(h.$$.fragment), (g = d()), y(c.$$.fragment));
			},
...
function vl(U) {
	let h, g, c, T, f, _, x, D, P, q;
	return (
		(h = new N({ props: { src: al, className: 'gallery-img' } })),
		(c = new N({ props: { src: ol, className: 'gallery-img' } })),
		(f = new N({ props: { src: sl, className: 'gallery-img' } })),
		(x = new N({ props: { src: nl, className: 'gallery-img' } })),
		(P = new N({ props: { src: il, className: 'gallery-img' } })),
		{
			c() {
				(y(h.$$.fragment),
					(g = d()),
			...
			d(u) {
				(k(h, u), u && t(g), k(c, u), u && t(T), k(f, u), u && t(_), k(x, u), u && t(D), k(P, u));
			}
		}
	);
}
function bl(U) {
	...
	return (
		(h = new Fr({
			props: { title: Il, publishDate: Tl, tags: El, slug: kl, thumbnail: _l, summary: Nl }
		})),
		(le = new N({
			props: {
				src: Kr,
		...
		(X = new ia({ props: { columns: '2', $$slots: { default: [ul] }, $$scope: { ctx: U } } })),
		(Z = new ia({ props: { columns: '2', $$slots: { default: [wl] }, $$scope: { ctx: U } } })),
		(K = new ia({ props: { columns: '2', $$slots: { default: [gl] }, $$scope: { ctx: U } } })),
		(fe = new N({
			props: {
				src: dl,
				className: 'gallery-img',
		...
		(he = new N({
			props: { src: cl, caption: 'High praise from the 🐐 in #election-night-notes.' }
		})),
		(ae = new ia({
			props: {
				columns: '2',
		...
		(ue = new N({ props: { src: tl, caption: 'Design systems library' } })),
		(we = new N({ props: { src: ml, caption: 'Maker Week Design Systems Library team.' } })),
		(ge = new N({
			props: {
				src: rl,
				caption:
		...
		(ye = new N({
			props: { src: ll, caption: 'The graphic that I designed for our 2022 Maker Week T-shirt!' }
		})),
		(se = new ia({
			props: {
				columns: '5',
		...
		})),
		{
			c() {
				(y(h.$$.fragment),
					(g = d()),
					(c = r('p')),
					(T = s('This past summer, I interned at the New York Times on the ')),
					(f = r('a')),
					(_ = s('Interactive News Team (INT)')),
					(x = s(
						'! I’ve had the pleasure of working on many projects at the Times, from UI/UX design to spreadsheet wrangling to illustration to fullstack software development. I had such a wonderful experience with the team and with the company, and I’m elated to share what I’ve learned.'
					)),
					(D = d()),
					(P = r('h2')),
					(q = s('Work-related projects')),
					(u = d()),
					(S = r('p')),
					(Eo = s(
					...
					(la = d()),
					(be = r('h3')),
					(_o = s('Elections asset layout editor')),
					(ma = d()),
					(W = r('p')),
					(No = s(
						'This was one of my biggest projects of the summer! Essentially, our elections reporting rig is composed of several apps which gather data, manage election events, publish pages, and more. The '
					)),
					(it = r('code')),
					(So = s('election-pages')),
					(Po = s(
						' app previews and renders all New York Times election results pages. I worked on an '
					)),
					(rt = r('strong')),
					(Ro = s('interactive wysiwyg-style editor for elections asset layouts')),
					(Ao = s('.')),
					(fa = d()),
					($e = r('p')),
					(jo = s(
					...
					(ha = d()),
					(J = r('h3')),
					(Uo = s('UI/UX improvements in the ')),
					(mt = r('code')),
					(xo = s('election-admin')),
					(Wo = s(' app')),
					(ca = d()),
					(O = r('p')),
					(Ho = s('One of my first projects on INT was a ')),
					(ft = r('strong')),
					(Co = s('UI/UX audit')),
					(Mo = s(' of our ')),
					(dt = r('code')),
					...
					(ua = d()),
					(Ie = r('p')),
					(qo = s('Here’s a detailed rundown of some changes that I implemented:')),
					(wa = d()),
					y(X.$$.fragment),
					(ga = d()),
					(ke = r('p')),
					(zo = s('For this first side-by-side comparison (above):')),
					(ya = d()),
					(R = r('ul')),
					(L = r('li')),
					(Jo = s(
						'I introduced section headers, splitting up the fields categorically to make the interface more self-explanatory. These include '
					)),
					(ht = r('strong')),
					(Xo = s('Asset Details')),
					(Qo = s(', ')),
					...
					(Ko = s(', ')),
					(ut = r('strong')),
					(Vo = s('Publication Details')),
					(es = s(', and ')),
					(wt = r('strong')),
					(ts = s('Advanced Options')),
					(as = d()),
					(gt = r('li')),
					(os = s(
					...
					(ss = d()),
					(Q = r('li')),
					(ns = s('I hid inferrable fields like ')),
					(yt = r('code')),
					(is = s('Asset type')),
					(rs = s(' and ')),
					(vt = r('code')),
					...
					(ba = d()),
					(Te = r('p')),
					(hs = s('For this second side-by-side:')),
					($a = d()),
					(H = r('ul')),
					(It = r('li')),
					(cs = s(
					...
					(gs = d()),
					(A = r('li')),
					(ys = s('I rearranged the layout of the publication details (')),
					(Tt = r('strong')),
					(vs = s('Times Tags')),
					(bs = s(', ')),
					(Et = r('strong')),
					...
					(Is = s(', ')),
					(_t = r('strong')),
					(ks = s('Promo Media Preview')),
					(Ts = s(', and ')),
					(Nt = r('strong')),
					(Es = s('Display Condition')),
					(_s = s(
						') to optimize text field widths and create a larger space for the image preview'
					)),
					(Ia = d()),
					y(K.$$.fragment),
					(ka = d()),
					...
					(Ss = d()),
					(j = r('li')),
					(Ps = s('I moved the rarely-edited-but-nice-to-have fields (')),
					(Pt = r('strong')),
					(Rs = s('Byline')),
					(As = s(', ')),
					(Rt = r('strong')),
					...
					(Us = s('Notes')),
					(xs = s(
						') into the “Advanced Options” section, which is hidden by default so as not to overwhelm users'
					)),
					(Ta = d()),
					(Ee = r('p')),
					(Ws = s(
					...
					(Ea = d()),
					(_e = r('h3')),
					(Hs = s('Trending races component')),
					(_a = d()),
					(ee = r('p')),
					(Cs = s('Finally, a project that is ')),
					(me = r('a')),
					(Ms = s('live')),
					(Ys = s(
						'! This trending races component was developed for the front page of the NYT elections results. It became one of my primary projects during October and November, and I’m thankful to have owned a feature that was so central to the Times’ election visuals, from the design to the development, animation, algorithm, and testing.'
					)),
					(Na = d()),
					y(fe.$$.fragment),
					(Sa = d()),
					...
					(Ga = d()),
					(Ae = r('h3')),
					(zs = s('Self-driving car crash data')),
					(Ua = d()),
					(te = r('p')),
					(Js = s(
					...
					(Ca = d()),
					(Le = r('h2')),
					(Vs = s('Semi work-related projects')),
					(Ma = d()),
					(Ge = r('h3')),
					(en = s('Maker Week 2022: Design systems library')),
					(Ya = d()),
					(Ue = r('p')),
					(tn = s(
					...
					(qa = d()),
					(oe = r('p')),
					(sn = s('Our Maker Week project ultimately won ')),
					(Ot = r('strong')),
					(nn = s('Most Likely to be Used by Everyone')),
					(rn = s(
						'. I was able to work with so many extremely talented people across different teams at the New York Times. Collaborating outside of my team bubble proved to be super insightful. Here’s my team that made this project possible:'
					)),
					(za = d()),
					y(we.$$.fragment),
					(Ja = d()),
					(He = r('h3')),
					(ln = s('Maker Week T-shirt design')),
					(Xa = d()),
					(Ce = r('p')),
					(mn = s(
					...
					(io = d()),
					(ne = r('p')),
					(gn = s('My heart also goes out to the ')),
					(Lt = r('code')),
					(yn = s('#snacks')),
					(vn = s(
						' channel. Several times a week, people would post excess food from events to this channel, free for the taking. Every day felt like a new adventure! I loved the spirit of generosity here, and I was even able to contribute food once myself, too.'
					)),
					(ro = d()),
					y(ve.$$.fragment),
					(lo = d()),
					...
					(fo = d()),
					(Qe = r('h2')),
					(In = s('On getting the internship')),
					(po = d()),
					(Ze = r('p')),
					(kn = s(
					...
					(Tn = s('STEP 1:')),
					(En = s(
						' I found the application on LinkedIn and applied through their Workday portal. They asked for the usual resume, as well as a few short essays. I could tell they were looking for applicants with a genuine interest in the intersection between journalism and software.'
					)),
					(_n = d()),
					(xt = r('li')),
					(Ve = r('p')),
					...
					(Nn = s('STEP 2:')),
					(Sn = s(
						' I did an automated video interview. This one honestly wasn’t great. The platform would ask a question, count down, and then film my timed response. There were no re-dos, and it cut me off automatically after two minutes.'
					)),
					(Pn = d()),
					(Ht = r('li')),
					(et = r('p')),
					...
					(w = r('p')),
					(xn = s(
						'Thank you so much to everyone at the Times who has made this summer such a valuable learning experience. It’s a notable investment that the team makes every year, and I felt so welcomed every step of the way. Thank you '
					)),
					(Dt = r('strong')),
					(Wn = s('Asmaa')),
					(Hn = s(
						' for being the best mentor I could ask for—thinking of our 1:1s always makes me smile. Thank you '
					)),
					(Bt = r('strong')),
					(Cn = s('Ben')),
					(Mn = s(', ')),
					...
					(qn = s('Amy')),
					(zn = s(
						' for ensuring that I had engaging projects to work on, and constantly reshaping my NYT path to fit my interests. Thank you to '
					)),
					(Jt = r('strong')),
					(Jn = s('Andrew F.')),
					(Xn = s(
						' for sharing incredible advice as my “intern buddy”, as well as to my intern friends for being my partners in crime ('
					)),
					(Xt = r('strong')),
					(Qn = s('Zully')),
					(Zn = s(', ')),
					...
					(ei = s('Connie')),
					(ti = s(
						', and so many more). Thank you to the INT team as a whole—you all are the smartest, kindest people that I’ve gotten to work with. Thank you to the Maker Week Team, to folks in the '
					)),
					(Kt = r('code')),
					(ai = s('#snacks')),
					(oi = s(' channel, and to ')),
					...
					(ea = r('strong')),
					(ii = s('Nya')),
					(ri = s(' for hosting a successful intern program. I hope we cross paths again!')),
					this.h());
			},
			l(e) {
				(v(h.$$.fragment, e), (g = p(e)), (c = l(e, 'P', {})));
				var o = m(c);
				((T = n(o, 'This past summer, I interned at the New York Times on the ')),
					(f = l(o, 'A', { href: !0, rel: !0 })));
				var ta = m(f);
				((_ = n(ta, 'Interactive News Team (INT)')),
					ta.forEach(t),
					(x = n(
						o,
						'! I’ve had the pleasure of working on many projects at the Times, from UI/UX design to spreadsheet wrangling to illustration to fullstack software development. I had such a wonderful experience with the team and with the company, and I’m elated to share what I’ve learned.'
					...
					(P = l(e, 'H2', {})));
				var aa = m(P);
				((q = n(aa, 'Work-related projects')), aa.forEach(t), (u = p(e)), (S = l(e, 'P', {})));
				var oa = m(S);
				((Eo = n(
					oa,
					'These were all so fun, I swear. Primarily elections, but also some one-off projects. The elections rig is written in TypeScript, Next.js, and a home-rolled variation on Sveltekit, with express and PostGreSQL handling the backend (if you’re curious)!'
					...
					(be = l(e, 'H3', {})));
				var sa = m(be);
				((_o = n(sa, 'Elections asset layout editor')),
					sa.forEach(t),
					(ma = p(e)),
					(W = l(e, 'P', {})));
				var B = m(W);
				...
				((So = n(pi, 'election-pages')),
					...
					(rt = l(B, 'STRONG', {})));
				var hi = m(rt);
				((Ro = n(hi, 'interactive wysiwyg-style editor for elections asset layouts')),
					hi.forEach(t),
					(Ao = n(B, '.')),
					B.forEach(t),
					(fa = p(e)),
				...
				((Lo = n(ui, 'election-admin')),
					...
					(J = l(e, 'H3', {})));
				var vo = m(J);
				((Uo = n(vo, 'UI/UX improvements in the ')), (mt = l(vo, 'CODE', {})));
				var wi = m(mt);
				((xo = n(wi, 'election-admin')),
					wi.forEach(t),
					(Wo = n(vo, ' app')),
					vo.forEach(t),
					(ca = p(e)),
					(O = l(e, 'P', {})));
				var ie = m(O);
				((Ho = n(ie, 'One of my first projects on INT was a ')), (ft = l(ie, 'STRONG', {})));
				var gi = m(ft);
				((Co = n(gi, 'UI/UX audit')),
					gi.forEach(t),
					(Mo = n(ie, ' of our ')),
					(dt = l(ie, 'CODE', {})));
				var yi = m(dt);
				((Yo = n(yi, 'election-admin')),
					yi.forEach(t),
					(Do = n(ie, ' app. ')),
					(pt = l(ie, 'CODE', {})));
				var vi = m(pt);
				((Bo = n(vi, 'election-admin')),
					vi.forEach(t),
					(Fo = n(
						ie,
						' is responsible for managing events and assets, whether they be standalone pages or embedded into others (such as on the home page). More specifically, I tackled the interface used to create and edit these assets. Having a more user-friendly interface would make it easier for different people to configure elections without significant training. We’d be able to run election nights more reliably and with fewer people.'
					...
					(Ie = l(e, 'P', {})));
				var bi = m(Ie);
				((qo = n(bi, 'Here’s a detailed rundown of some changes that I implemented:')),
					bi.forEach(t),
					(wa = p(e)),
					v(X.$$.fragment, e),
					(ga = p(e)),
					(ke = l(e, 'P', {})));
				var $i = m(ke);
				((zo = n($i, 'For this first side-by-side comparison (above):')),
					$i.forEach(t),
					(ya = p(e)),
					(R = l(e, 'UL', {})));
				var C = m(R);
				...
				((Jo = n(
					...
					(ht = l(F, 'STRONG', {})));
				var Ii = m(ht);
				((Xo = n(Ii, 'Asset Details')),
					Ii.forEach(t),
					(Qo = n(F, ', ')),
					(ct = l(F, 'STRONG', {})));
				var ki = m(ct);
				((Zo = n(ki, 'Event Details')),
					ki.forEach(t),
					(Ko = n(F, ', ')),
					(ut = l(F, 'STRONG', {})));
				var Ti = m(ut);
				((Vo = n(Ti, 'Publication Details')),
					Ti.forEach(t),
					(es = n(F, ', and ')),
					(wt = l(F, 'STRONG', {})));
				var Ei = m(wt);
				((ts = n(Ei, 'Advanced Options')),
					Ei.forEach(t),
					F.forEach(t),
					(as = p(C)),
					(gt = l(C, 'LI', {})));
				...
				((os = n(
					...
					(Q = l(C, 'LI', {})));
				var na = m(Q);
				((ns = n(na, 'I hid inferrable fields like ')), (yt = l(na, 'CODE', {})));
				var Ni = m(yt);
				((is = n(Ni, 'Asset type')),
					Ni.forEach(t),
					(rs = n(na, ' and ')),
				...
				((ps = n(
					...
					(Te = l(e, 'P', {})));
				var Ai = m(Te);
				((hs = n(Ai, 'For this second side-by-side:')),
					Ai.forEach(t),
					($a = p(e)),
					(H = l(e, 'UL', {})));
				var st = m(H);
				...
				((ws = n(
					...
					(A = l(st, 'LI', {})));
				var M = m(A);
				((ys = n(M, 'I rearranged the layout of the publication details (')),
					(Tt = l(M, 'STRONG', {})));
				var Li = m(Tt);
				((vs = n(Li, 'Times Tags')), Li.forEach(t), (bs = n(M, ', ')), (Et = l(M, 'STRONG', {})));
				var Gi = m(Et);
				(($s = n(Gi, 'Promo Media ID')),
					Gi.forEach(t),
					(Is = n(M, ', ')),
					(_t = l(M, 'STRONG', {})));
				var Ui = m(_t);
				((ks = n(Ui, 'Promo Media Preview')),
					Ui.forEach(t),
					(Ts = n(M, ', and ')),
					(Nt = l(M, 'STRONG', {})));
				var xi = m(Nt);
				((Es = n(xi, 'Display Condition')),
					xi.forEach(t),
					(_s = n(
						M,
						') to optimize text field widths and create a larger space for the image preview'
				...
				((Ns = n(
					...
					(j = l(bo, 'LI', {})));
				var Y = m(j);
				((Ps = n(Y, 'I moved the rarely-edited-but-nice-to-have fields (')),
					(Pt = l(Y, 'STRONG', {})));
				var Hi = m(Pt);
				((Rs = n(Hi, 'Byline')), Hi.forEach(t), (As = n(Y, ', ')), (Rt = l(Y, 'STRONG', {})));
				var Ci = m(Rt);
				((js = n(Ci, 'Correction')), Ci.forEach(t), (Os = n(Y, ', ')), (At = l(Y, 'STRONG', {})));
				var Mi = m(At);
				((Ls = n(Mi, 'Credit')), Mi.forEach(t), (Gs = n(Y, ', and ')), (jt = l(Y, 'STRONG', {})));
				var Yi = m(jt);
				((Us = n(Yi, 'Notes')),
					Yi.forEach(t),
					(xs = n(
				...
				((Ws = n(
					...
					(_e = l(e, 'H3', {})));
				var Bi = m(_e);
				((Hs = n(Bi, 'Trending races component')),
					Bi.forEach(t),
					(_a = p(e)),
					(ee = l(e, 'P', {})));
				var $o = m(ee);
				((Cs = n($o, 'Finally, a project that is ')), (me = l($o, 'A', { href: !0, rel: !0 })));
				var Fi = m(me);
				((Ms = n(Fi, 'live')),
					Fi.forEach(t),
					(Ys = n(
				...
				((qs = n(
					...
					(Ae = l(e, 'H3', {})));
				var Qi = m(Ae);
				((zs = n(Qi, 'Self-driving car crash data')),
					Qi.forEach(t),
					(Ua = p(e)),
					(te = l(e, 'P', {})));
				var Io = m(te);
				...
				((Ks = n(
					...
					(Le = l(e, 'H2', {})));
				var er = m(Le);
				((Vs = n(er, 'Semi work-related projects')),
					er.forEach(t),
					(Ma = p(e)),
					(Ge = l(e, 'H3', {})));
				var tr = m(Ge);
				((en = n(tr, 'Maker Week 2022: Design systems library')),
					tr.forEach(t),
					(Ya = p(e)),
					(Ue = l(e, 'P', {})));
				var ar = m(Ue);
				...
				((on = n(
					...
					(oe = l(e, 'P', {})));
				var ko = m(oe);
				((sn = n(ko, 'Our Maker Week project ultimately won ')), (Ot = l(ko, 'STRONG', {})));
				var nr = m(Ot);
				((nn = n(nr, 'Most Likely to be Used by Everyone')),
					nr.forEach(t),
					(rn = n(
						ko,
						'. I was able to work with so many extremely talented people across different teams at the New York Times. Collaborating outside of my team bubble proved to be super insightful. Here’s my team that made this project possible:'
					...
					(He = l(e, 'H3', {})));
				var ir = m(He);
				((ln = n(ir, 'Maker Week T-shirt design')),
					ir.forEach(t),
					(Xa = p(e)),
					(Ce = l(e, 'P', {})));
				var rr = m(Ce);
				...
				((fn = n(
					...
					(Ye = l(e, 'H3', {})));
				var mr = m(Ye);
				((dn = n(mr, 'Intern newsletter')), mr.forEach(t), (eo = p(e)), (De = l(e, 'P', {})));
				var fr = m(De);
				((pn = n(
					fr,
					'This summer, our intern class produced two newsletters, with all articles and accompanying media created by Times interns. I designed the 2022 newsletter layout with Zoe and Kalynka in Figma. We aimed to replicate the print-newspaper-esque aesthetic while still maintaining readability in the narrow format of a newsletter. As product design interns, they imparted wonderful design insight that I learned so much from!'
					...
					(Be = l(e, 'H2', {})));
				var dr = m(Be);
				((hn = n(dr, 'Community and experience')),
					dr.forEach(t),
					(oo = p(e)),
					(Fe = l(e, 'P', {})));
				var pr = m(Fe);
				...
				((wn = n(
					...
					(ne = l(e, 'P', {})));
				var To = m(ne);
				((gn = n(To, 'My heart also goes out to the ')), (Lt = l(To, 'CODE', {})));
				var ur = m(Lt);
				((yn = n(ur, '#snacks')),
					ur.forEach(t),
					(vn = n(
				...
				(($n = n(
					...
					(Qe = l(e, 'H2', {})));
				var yr = m(Qe);
				((In = n(yr, 'On getting the internship')),
					yr.forEach(t),
					(po = p(e)),
					(Ze = l(e, 'P', {})));
				var vr = m(Ze);
				...
				((Gn = n(
					...
					(ot = l(e, 'H2', {})));
				var Pr = m(ot);
				((Un = n(Pr, 'Thank you!')), Pr.forEach(t), (wo = p(e)), (w = l(e, 'P', {})));
				var E = m(w);
				((xn = n(
					E,
					'Thank you so much to everyone at the Times who has made this summer such a valuable learning experience. It’s a notable investment that the team makes every year, and I felt so welcomed every step of the way. Thank you '
				...
				((Wn = n(Rr, 'Asmaa')),
					...
					(Bt = l(E, 'STRONG', {})));
				var Ar = m(Bt);
				((Cn = n(Ar, 'Ben')), Ar.forEach(t), (Mn = n(E, ', ')), (Ft = l(E, 'STRONG', {})));
				var jr = m(Ft);
				((Yn = n(jr, 'Rachel')), jr.forEach(t), (Dn = n(E, ', ')), (qt = l(E, 'STRONG', {})));
				var Or = m(qt);
				((Bn = n(Or, 'Scott')), Or.forEach(t), (Fn = n(E, ', and ')), (zt = l(E, 'STRONG', {})));
				var Lr = m(zt);
				((qn = n(Lr, 'Amy')),
					Lr.forEach(t),
					(zn = n(
				...
				((Jn = n(Gr, 'Andrew F.')),
					...
					(Xt = l(E, 'STRONG', {})));
				var Ur = m(Xt);
				((Qn = n(Ur, 'Zully')), Ur.forEach(t), (Zn = n(E, ', ')), (Qt = l(E, 'STRONG', {})));
				var xr = m(Qt);
				((Kn = n(xr, 'Zoe')), xr.forEach(t), (Vn = n(E, ', ')), (Zt = l(E, 'STRONG', {})));
				var Wr = m(Zt);
				((ei = n(Wr, 'Connie')),
					Wr.forEach(t),
					(ti = n(
				...
				((ai = n(Hr, '#snacks')),
					Hr.forEach(t),
					(oi = n(E, ' channel, and to ')),
					(Vt = l(E, 'STRONG', {})));
				var Cr = m(Vt);
				((si = n(Cr, 'Ashton')), Cr.forEach(t), (ni = n(E, ' and ')), (ea = l(E, 'STRONG', {})));
				var Mr = m(ea);
				((ii = n(Mr, 'Nya')),
					Mr.forEach(t),
					(ri = n(E, ' for hosting a successful intern program. I hope we cross paths again!')),
					E.forEach(t),
					this.h());
			},
			h() {
				(nt(f, 'href', 'https://github.com/newsdev/about-int'),
					nt(f, 'rel', 'nofollow'),
					nt(
						me,
						'href',
			...
			p(e, [o]) {
				const ta = {};
				(o & 1 && (ta.$$scope = { dirty: o, ctx: e }), X.$set(ta));
				const aa = {};
				(o & 1 && (aa.$$scope = { dirty: o, ctx: e }), Z.$set(aa));
				const oa = {};
				(o & 1 && (oa.$$scope = { dirty: o, ctx: e }), K.$set(oa));
				const sa = {};
				(o & 1 && (sa.$$scope = { dirty: o, ctx: e }), ae.$set(sa));
				const B = {};
				(o & 1 && (B.$$scope = { dirty: o, ctx: e }), se.$set(B));
			},
			i(e) {
				go ||
					($(h.$$.fragment, e),
...
const $l = {
	...
	{ title: Il, slug: kl, publishDate: Tl, tags: El, thumbnail: _l, summary: Nl } = $l;
class Al extends Yr {
	constructor(h) {
		(super(), Dr(this, h, null, bl, Br, {}));
	}
}
export { Al as default, $l as metadata };
