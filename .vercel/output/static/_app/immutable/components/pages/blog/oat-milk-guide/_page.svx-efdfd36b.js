...
import { B as ya, P as _a } from '../../../../chunks/BlogImage-f532aefd.js';
/* empty css                             */ function Ia(T) {
	let p, k, _, f, g;
	const I = T[3].default,
		c = wa(I, T, T[2], null);
	return (
		(f = new ya({ props: { src: T[0], caption: T[1], className: 'half-img' } })),
		{
			c() {
				((p = l('div')), (k = l('div')), c && c.c(), (_ = u()), Et(f.$$.fragment), this.h());
			},
			l(d) {
				p = s(d, 'DIV', { class: !0 });
				var b = r(p);
				k = s(b, 'DIV', { class: !0 });
				var $ = r(k);
				(c && c.l($), $.forEach(t), (_ = h(b)), xt(f.$$.fragment, b), b.forEach(t), this.h());
			},
			h() {
				(Se(k, 'class', 'text'), Se(p, 'class', 'wrapper svelte-etu8lb'));
			},
			m(d, b) {
				(m(d, p, b), a(p, k), c && c.m(k, null), a(p, _), $t(f, p, null), (g = !0));
			},
			p(d, [b]) {
				c && c.p && (!g || b & 4) && ba(c, I, d, d[2], g ? ga(I, d[2], b, null) : va(d[2]), null);
				const $ = {};
				(b & 1 && ($.src = d[0]), b & 2 && ($.caption = d[1]), f.$set($));
			},
			i(d) {
				g || (yt(c, d), yt(f.$$.fragment, d), (g = !0));
			},
			o(d) {
				(wt(c, d), wt(f.$$.fragment, d), (g = !1));
			},
			d(d) {
				(d && t(p), c && c.d(d), zt(f));
			}
...
function Ea(T, p, k) {
	let { $$slots: _ = {}, $$scope: f } = p,
		{ image: g } = p,
		{ caption: I } = p;
	return (
		(T.$$set = (c) => {
			('image' in c && k(0, (g = c.image)),
				'caption' in c && k(1, (I = c.caption)),
				'$$scope' in c && k(2, (f = c.$$scope)));
		}),
		[g, I, f, _]
	);
}
class xa extends pa {
	constructor(p) {
		(super(), da(this, p, Ea, Ia, ca, { image: 0, caption: 1 }));
	}
}
const $a = '' + new URL('../../../../assets/oat-milk-1e8fac81.png', import.meta.url).href,
	za = '' + new URL('../../../../assets/brownies-349f4c60.jpg', import.meta.url).href;
function Pa(T) {
	let p,
		k,
		_,
	...
	return {
		c() {
			((p = l('h3')),
				...
				(b = l('b')),
				($ = o('3')),
				(ge = o(' bananas (or another sweetener)')),
				(C = u()),
				(U = l('li')),
				(J = l('b')),
				(B = o('2')),
				...
				(re = l('b')),
				(ke = o('¼ cup')),
				(V = o(' oil (coconut, olive, etc.)')),
				(We = u()),
				(A = l('li')),
				(E = l('b')),
				(je = o('½ cup')),
				(q = o(' nut butter (I use peanut butter powder!)')),
				(Oe = u()),
				(Y = l('li')),
				(P = l('b')),
				(Ae = o('1 tsp')),
				(qe = o(' vanilla extract')),
				(_e = u()),
				(L = l('li')),
				(ne = l('b')),
				(Ie = o('1 tsp')),
				(S = o(' instant coffee powder')),
				(Me = u()),
				(H = l('li')),
				(me = l('b')),
				(Re = o('1 tsp')),
				...
				(j = l('ol')),
				(R = l('li')),
				(Ne = o('Blend or mix it all together!')),
				(Ve = u()),
				(D = l('li')),
				(Ye = o('Bake at 350˚F for 25-30 min.')));
		},
		l(w) {
			p = s(w, 'H3', {});
			var x = r(p);
			((k = i(x, 'Ingredients:')), x.forEach(t), (_ = h(w)), (f = s(w, 'UL', {})));
			var y = r(f);
			g = s(y, 'LI', {});
			var Ke = r(g);
			((I = i(Ke, 'oat pulp!')), Ke.forEach(t), (c = h(y)), (d = s(y, 'LI', {})));
			var G = r(d);
			b = s(G, 'B', {});
			var Qe = r(b);
			(($ = i(Qe, '3')),
				Qe.forEach(t),
				(ge = i(G, ' bananas (or another sweetener)')),
				G.forEach(t),
				(C = h(y)),
				(U = s(y, 'LI', {})));
			var ae = r(U);
			...
			((je = i(Ze, '½ cup')),
				Ze.forEach(t),
				(q = i(Xe, ' nut butter (I use peanut butter powder!)')),
				Xe.forEach(t),
				(Oe = h(y)),
				(Y = s(y, 'LI', {})));
			var oe = r(Y);
			...
			((Je = i(it, '1 cup')),
				it.forEach(t),
				(pe = i(ot, ' almond flour')),
				ot.forEach(t),
				y.forEach(t),
				(ze = h(w)),
				(te = s(w, 'H3', {})));
			var be = r(te);
			((de = i(be, 'Instructions:')), be.forEach(t), (Pe = h(w)), (j = s(w, 'OL', {})));
			var Be = r(j);
			R = s(Be, 'LI', {});
			var lt = r(R);
			((Ne = i(lt, 'Blend or mix it all together!')),
				lt.forEach(t),
				(Ve = h(Be)),
				(D = s(Be, 'LI', {})));
			var ve = r(D);
			((Ye = i(ve, 'Bake at 350˚F for 25-30 min.')), ve.forEach(t), Be.forEach(t));
		},
		m(w, x) {
			(m(w, p, x),
				a(p, k),
		...
		p: ka,
		d(w) {
			(w && t(p), w && t(_), w && t(f), w && t(ze), w && t(te), w && t(Pe), w && t(j));
		}
	};
}
function La(T) {
	...
	return (
		(p = new _a({
			props: { title: Ta, publishDate: Sa, tags: Ha, thumbnail: Wa, slug: Ba, summary: ja }
		})),
		(G = new ya({ props: { src: $a, caption: 'Matcha oat milk and cherry blossoms.' } })),
		(O = new xa({
			props: {
				image: za,
		...
		})),
		{
			c() {
				(Et(p.$$.fragment),
					...
					(B = l('p')),
					(He = o(
						'I won’t keep you waiting—here’s the recipe! Blend together 4 cups of water, 1 cup of oats, 1 teaspoon of vanilla extract, a pinch of salt, and sweetener to taste. Then, strain the mixture with a tea towel or cheesecloth to separate the oat milk from the oat pulp. Sounds simple, right? I can tell you now that it really '
					)),
					(se = l('em')),
					(N = o('is')),
					(re = o(
						' quite simple, but my first couple “experiments” were so messy and subpar that my mom essentially begged me never to make oat milk again.'
					)),
					(ke = u()),
					(V = l('p')),
					(We = o(
					...
					(E = l('p')),
					(je = o(
						'Oats are partially composed of starch granules. When heated (such as while cooking oatmeal), these granules swell as they absorb water, a process otherwise known as starch gelatinization. Gelatinization is common to other starches as well, but it begins in oats at around '
					)),
					(q = l('a')),
					(Oe = o('45')),
					(Y = o(' to ')),
					(P = l('a')),
					(Ae = o('60')),
					(qe = o('˚C (a range, because I can’t seem to find sources that agree).')),
					(_e = u()),
					(L = l('p')),
					(ne = o(
					...
					(v = l('ul')),
					(he = l('li')),
					(Ce = o('matcha milk tea (1 tbsp of matcha powder)')),
					(Ue = u()),
					(W = l('li')),
					(fe = o('chocolate milk (2 tbsp of cacao powder)')),
					(Je = u()),
					(pe = l('li')),
					(ze = o('earl grey milk tea (use steeped tea in lieu of water)')),
					(te = u()),
					(de = l('li')),
					(Pe = o('cold brew latte (1 tsp instant coffee)')),
					(j = u()),
					(R = l('li')),
					(Ne = o(
					...
					(w = u()),
					(x = l('li')),
					(y = o('cinnamon spice milk (1 tsp cinnamon, 1 tsp pumpkin spice)')),
					(Ke = u()),
					Et(G.$$.fragment),
					(Qe = u()),
					(ae = l('p')),
...
Here’s my brownie recipe. It’s food processor-friendly!`)),
					...
					(vt = u()),
					(le = l('p')),
					(Ft = o('On the other hand, there ')),
					(dt = l('em')),
					(Tt = o('is')),
					(Bt = o(
						' a scenario where homemade oat milk is preferable to its store-bought counterpart, namely oat yogurt. Whereas we’re avoiding gelatinization while making oat milk, we actually take advantage of this thickening while making oat yogurt. With most non-dairy milks (almond, cashew, soy), we usually need a thickening agent to give the yogurt structure, whether it be pectin, agar-agar, or something else. Thankfully, oats have this property built in! Homemade oat yogurt effectively follows the same process as oat milk, but you don’t need to keep anything cold. The strained milk mix is simmered on the stove right after, anyway! I use this '
					)),
					(st = l('a')),
					(St = o('recipe')),
					(Ht = o(
						', and it’s continuously served me well. It’s also super simple! Bring your mixture to 180˚F while whisking and without boiling, remove from the heat, and cool (while still whisking) until 115˚F. Finally, stir in the yogurt starter/existing yogurt, ferment in a warm place for at least eight hours, and enjoy!'
					)),
					(gt = u()),
					(ht = l('p')),
					(Wt = o(
			...
			l(e) {
				...
				((c = i(
					...
					(b = s(e, 'P', {})));
				var jt = r(b);
				(($ = i(jt, ' ')), jt.forEach(t), (ge = h(e)), (C = s(e, 'H2', {})));
				var Ot = r(C);
				((U = i(Ot, 'Oat milk basics')), Ot.forEach(t), (J = h(e)), (B = s(e, 'P', {})));
				var _t = r(B);
				((He = i(
					_t,
					'I won’t keep you waiting—here’s the recipe! Blend together 4 cups of water, 1 cup of oats, 1 teaspoon of vanilla extract, a pinch of salt, and sweetener to taste. Then, strain the mixture with a tea towel or cheesecloth to separate the oat milk from the oat pulp. Sounds simple, right? I can tell you now that it really '
				...
				((je = i(
					...
					(q = s(ft, 'A', { href: !0, rel: !0 })));
				var Mt = r(q);
				((Oe = i(Mt, '45')),
					Mt.forEach(t),
					(Y = i(ft, ' to ')),
					(P = s(ft, 'A', { href: !0, rel: !0 })));
				var Rt = r(P);
				((Ae = i(Rt, '60')),
					Rt.forEach(t),
					(qe = i(ft, '˚C (a range, because I can’t seem to find sources that agree).')),
					ft.forEach(t),
					(_e = h(e)),
					(L = s(e, 'P', {})));
				var Dt = r(L);
				((ne = i(
					...
					(S = s(e, 'P', {})));
				var It = r(S);
				((Me = i(It, 'Essentially, you’ll want to ')), (H = s(It, 'STRONG', {})));
				var Gt = r(H);
				((me = i(Gt, 'optimize the cold environment')),
					Gt.forEach(t),
					(Re = i(
						It,
						' while making oat milk to avoid the onset of gelatinization. For me, this optimization looks like refrigerating all ingredients for at least a couple of hours before blending and straining—especially the water and sweetener (I use three soaked medjool dates). In a similar vein, I keep my blending duration to a minimum: 5-10 second increments, with 10 seconds of “rest time” in between. I strain as quickly as possible to get my milk back in the fridge, and I also cool my hands down with ice water before working.'
				...
				((Q = i(
					...
					(Z = s(e, 'P', {})));
				var Ut = r(Z);
				((De = i(Ut, ' ')), Ut.forEach(t), (xe = h(e)), (F = s(e, 'H2', {})));
				var Jt = r(F);
				((ue = i(Jt, 'Flavored milk')), Jt.forEach(t), ($e = h(e)), (ee = s(e, 'P', {})));
				var Nt = r(ee);
				((Ge = i(
					Nt,
					'After understanding the thickening properties of oats, mastering the basics for an immaculate milk base follows without a sweat. It’s also the hardest part! You really can’t go wrong when experimenting with new flavors. Some of my favorite variations include:'
				...
				he = s(z, 'LI', {});
				var Vt = r(he);
				((Ce = i(Vt, 'matcha milk tea (1 tbsp of matcha powder)')),
					Vt.forEach(t),
					(Ue = h(z)),
					(W = s(z, 'LI', {})));
				var Yt = r(W);
				((fe = i(Yt, 'chocolate milk (2 tbsp of cacao powder)')),
					Yt.forEach(t),
					(Je = h(z)),
					(pe = s(z, 'LI', {})));
				var Kt = r(pe);
				((ze = i(Kt, 'earl grey milk tea (use steeped tea in lieu of water)')),
					Kt.forEach(t),
					(te = h(z)),
					(de = s(z, 'LI', {})));
				var Qt = r(de);
				((Pe = i(Qt, 'cold brew latte (1 tsp instant coffee)')),
					Qt.forEach(t),
					(j = h(z)),
					(R = s(z, 'LI', {})));
				var Xt = r(R);
				...
				((Ye = i(
					...
					(x = s(z, 'LI', {})));
				var ea = r(x);
				((y = i(ea, 'cinnamon spice milk (1 tsp cinnamon, 1 tsp pumpkin spice)')),
					ea.forEach(t),
					z.forEach(t),
					(Ke = h(e)),
					xt(G.$$.fragment, e),
				...
				((rt = i(
					...
					(ce = s(e, 'P', {})));
				var aa = r(ce);
				((Xe = i(aa, ' ')), aa.forEach(t), (Ze = h(e)), (oe = s(e, 'H2', {})));
				var oa = r(oe);
				((nt = i(oa, 'What to do with oat pulp')),
					oa.forEach(t),
					(Fe = h(e)),
					(ye = s(e, 'P', {})));
				var ia = r(ye);
...
Here’s my brownie recipe. It’s food processor-friendly!`
				...
				((ot = i(
					...
					(be = s(e, 'P', {})));
				var ra = r(be);
				((Be = i(ra, ' ')), ra.forEach(t), (lt = h(e)), (ve = s(e, 'H2', {})));
				var na = r(ve);
				((Pt = i(na, 'Additional notes')), na.forEach(t), (bt = h(e)), (ut = s(e, 'P', {})));
				var ma = r(ut);
				((Lt = i(
					ma,
					'While this homemade oat milk is amazing cold or at room temperature, it’ll still cook up when heated. This means no steamy, creamy lattes unless you add stabilizers that prevent gelatinization. The good news is that most store-bought oat milk brands use stabilizers, so I rely Trader Joe’s oat milk for hot drinks instead.'
					...
					(le = s(e, 'P', {})));
				var pt = r(le);
				((Ft = i(pt, 'On the other hand, there ')), (dt = s(pt, 'EM', {})));
				var ua = r(dt);
				((Tt = i(ua, 'is')),
					ua.forEach(t),
					(Bt = i(
			...
			h() {
				(Se(
					q,
					'href',
					'http://www.cerealsgrains.org/publications/cc/backissues/1996/Documents/73_271.pdf'
				),
					Se(q, 'rel', 'nofollow'),
					Se(P, 'href', 'https://www.agriculturejournals.cz/publicFiles/297_2010-CJFS.pdf'),
					Se(P, 'rel', 'nofollow'),
					Se(st, 'href', 'https://myfermentedfoods.com/how-make-vegan-yogurt/'),
					Se(st, 'rel', 'nofollow'));
			},
			m(e, n) {
				($t(p, e, n),
			...
			p(e, [n]) {
				const ct = {};
				(n & 1 && (ct.$$scope = { dirty: n, ctx: e }), O.$set(ct));
			},
			i(e) {
				kt || (yt(p.$$.fragment, e), yt(G.$$.fragment, e), yt(O.$$.fragment, e), (kt = !0));
			},
			o(e) {
				(wt(p.$$.fragment, e), wt(G.$$.fragment, e), wt(O.$$.fragment, e), (kt = !1));
			},
			d(e) {
				(zt(p, e),
					e && t(k),
...
const Fa = {
	...
	{ title: Ta, slug: Ba, publishDate: Sa, tags: Ha, thumbnail: Wa, summary: ja } = Fa;
class Ma extends pa {
	constructor(p) {
		(super(), da(this, p, null, La, ca, {}));
	}
}
export { Ma as default, Fa as metadata };
