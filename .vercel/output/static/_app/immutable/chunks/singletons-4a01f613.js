import { w as u } from './index-69919d61.js';
let f = '',
	g = '';
function R(e) {
	((f = e.base), (g = e.assets || f));
}
let h = '';
function k(e) {
	h = e;
}
const x = 'sveltekit:scroll',
	I = 'sveltekit:index',
	d = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1 };
function y(e) {
	let t = e.baseURI;
	if (!t) {
...
function T(e, t) {
	...
	const o = {
		...
		a = !n || w(n, t) || o.rel_external || o.target || o.download;
	return { url: n, has: o, external: a };
}
function U(e) {
	let t = null,
		n = null,
	...
	for (; s && s !== document.documentElement; )
		(n === null && (n = l(s, 'preload-code')),
			o === null && (o = l(s, 'preload-data')),
			t === null && (t = l(s, 'noscroll')),
			a === null && (a = l(s, 'reload')),
			(s = b(s)));
	return {
		preload_code: p[n ?? 'off'],
		preload_data: p[o ?? 'off'],
...
function _(e) {
	...
	return { notify: o, set: a, subscribe: s };
}
function v() {
	...
	async function o() {
		clearTimeout(n);
		const a = await fetch(`${g}/_app/version.json`, {
			headers: { pragma: 'no-cache', 'cache-control': 'no-cache' }
		});
		if (a.ok) {
			const r = (await a.json()).version !== h;
...
const O = { url: _({}), page: _({}), navigating: u(null), updated: v() };
export {
	I,
	d as P,
	x as S,
